...
void MGEDemo::_initializeScene()
{
    ...
    AbstractMaterial* runicStoneMaterial = new TextureMaterial (Texture::load (config::MGE_TEXTURE_PATH+"runicfloor.png"), Texture::load(config::MGE_TEXTURE_PATH + "runicfloor.png"));
